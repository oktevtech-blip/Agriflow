...
const seedFarmers: Farmer[] = [
  { id: 'f1', name: 'Kwame Mensah', phone: '+233 24 555 0101', location: 'Kumasi, Ashanti', farm_size_hectares: 4.5, created_at: daysAgo(120) },
  { id: 'f2', name: 'Ama Serwaa', phone: '+233 24 555 0102', location: 'Techiman, Bono East', farm_size_hectares: 8.0, created_at: daysAgo(110) },
  { id: 'f3', name: 'Yaw Boateng', phone: '+233 24 555 0103', location: 'Tamale, Northern', farm_size_hectares: 12.0, created_at: daysAgo(100) },
  { id: 'f4', name: 'Akosua Asante', phone: '+233 24 555 0104', location: 'Ho, Volta', farm_size_hectares: 3.2, created_at: daysAgo(90) },
  { id: 'f5', name: 'Kofi Owusu', phone: '+233 24 555 0105', location: 'Wa, Upper West', farm_size_hectares: 6.5, created_at: daysAgo(85) },
  { id: 'f6', name: 'Adwoa Nyame', phone: '+233 24 555 0106', location: 'Cape Coast, Central', farm_size_hectares: 5.0, created_at: daysAgo(80) },
  { id: 'f7', name: 'Ekow Mensah', phone: '+233 24 555 0107', location: 'Sunyani, Bono', farm_size_hectares: 7.8, created_at: daysAgo(70) },
  { id: 'f8', name: 'Abena Dapaah', phone: '+233 24 555 0108', location: 'Bolgatanga, Upper East', farm_size_hectares: 9.3, created_at: daysAgo(60) },
  { id: 'f9', name: 'Nana Yaw', phone: '+233 24 555 0109', location: 'Kintampo, Bono East', farm_size_hectares: 15.0, created_at: daysAgo(50) },
  { id: 'f10', name: 'Mansa Musa', phone: '+233 24 555 0110', location: 'Navorongo, Upper West', farm_size_hectares: 4.0, created_at: daysAgo(40) },
];
